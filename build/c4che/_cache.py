...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-lEonRF/python3.6-3.6.8=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-lEonRF/python3.6-3.6.8=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-lEonRF/python3.6-3.6.8=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-lEonRF/python3.6-3.6.8=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['realtime', 'matrix-topology', 'tutorial', 'traffic-control', 'energy', 'udp-client-server', 'tcp', 'ipv6', 'error-model', 'stats', 'socket', 'wireless', 'routing', 'naming', 'udp']
...
NS3_EXECUTABLE_PATH = ['/home/synrg/ns-allinone-3.30/ns-3.30/build/src/fd-net-device', '/home/synrg/ns-allinone-3.30/ns-3.30/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/synrg/ns-allinone-3.30/ns-3.30/build/lib']
...
VERSION = '3.30'
WITH_PYBINDGEN = '/home/synrg/ns-allinone-3.30/pybindgen-0.20.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/synrg/ns-allinone-3.30/ns-3.30/build/ns3/config-store-config.h', '/home/synrg/ns-allinone-3.30/ns-3.30/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
